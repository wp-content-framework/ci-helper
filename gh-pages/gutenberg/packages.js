...
const editWidgets = require( "@wordpress/edit-widgets" );
...
const reusableBlocks = require( "@wordpress/reusable-blocks" );
...
window.wp.editWidgets = window.wp.editWidgets || editWidgets;
...
window.wp.reusableBlocks = window.wp.reusableBlocks || reusableBlocks;
